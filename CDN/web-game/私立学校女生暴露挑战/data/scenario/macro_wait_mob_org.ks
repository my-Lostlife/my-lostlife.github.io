...
[macro name=モブ昼]
[iscript]
	f.mob = getRandItem(["man", "woman", "kid_b", "kid_g", "police"])
[endscript]
[chara_show name="& f.mob" time=0]
[endmacro]

*mob_night
[macro name=モブ夜]
[iscript]
	f.mob = getRandItem(["man", "woman", "jd1", "jk1", "police"])
[endscript]
[chara_show name="& f.mob" time=0]
[endmacro]
...
[macro name=学校モブ]
[iscript]
	f.mob = getRandItem(["man", "woman", "jd1", "jd2", "jk1", "jk2"])
[endscript]
[chara_show name="& f.mob" time=0]
[endmacro]
...
/*
;wait満足度適用
[if exp="f.wait_bonus > 0"]
	[eval exp="f.satisfaction = f.satisfaction += f.wait_bonus"]
[endif]


;オレンジ、赤ボーナス適用
[if exp="f.bonus_orange == true"]
	[eval exp="f.satisfaction += 5"]
[elsif exp="f.bonus_red == true"]
	[eval exp="f.satisfaction += 10"]
[endif]
...
@jump storage="game_play.ks" target="game_clear"
[endif]
[endmacro]
...
[if exp="f.orgasm >= 100"]
	[chara_part name="orgasm_gauge" orgasm_gauge=100  time=0]
@jump storage="game_play.ks" target="orgasm"
[endif]
[endmacro]
...
;ボイス
[if exp="f.expose_rank == 1"]
	[playse buf=2 storage="echioto_ああっ04.mp3"]
[elsif exp="f.expose_rank == 2"]
	[playse buf=2 storage="echioto_んっんっ02.mp3"]
[elsif exp="f.expose_rank == 3"]
	[playse buf=2 storage="echioto_おっ02.mp3"]
[endif]
[endmacro]
